...
public class PoiControlManual implements HBAction, HBReset {
    ...
    boolean upDownMovementValid = false;
    boolean lrDownMovementValid = false;


    final double ACCEL_GYRO_THRESHOLD = 0.08;

    // moving the gyro at a rate greater than this amount will change the field of view
    final double FOV_GYRO_THRESHOLD = 0.5;
    ...
    public void action(HB hb) {
        ...
        TriggerControl increaseFov = new TriggerControl(this, "Increas Fov") {
            @Override
            public void triggerEvent() {/* Write your DynamicControl code below this line */
                double current_fov = fieldOfViewControl.getValue();

                double new_fov = changeFieldOfView(true);
        ...
        };/* End DynamicControl increaseFov code */


        TriggerControl decreaseFov = new TriggerControl(this, "Decrease FOV") {
            @Override
            public void triggerEvent() {/* Write your DynamicControl code below this line */
                double current_fov = fieldOfViewControl.getValue();

                double new_fov = changeFieldOfView(false);
        ...
        };/* End DynamicControl decreaseFov code */
        ...
        new GyroscopeListener(hb) {
            ...
            public void sensorUpdated(float pitch, float roll, float yaw) {
                ...
                upDownMovementValid = averageGyro > ACCEL_GYRO_THRESHOLD;


                averageGyro = Math.sqrt( pitch * pitch + yaw * yaw);

                lrDownMovementValid = averageGyro > ACCEL_GYRO_THRESHOLD;
    ...
    private boolean lowResolutionMode() {
        return  false; //fieldsOfView[currentFovIndex] >= FOV_SENSOR_THRESHOLD;
    }
