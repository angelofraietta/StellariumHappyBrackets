...
public class StellariumMirror implements HBAction, HBReset {
...
*/
         ...
         *************************************************************/
        TextControl coordinatesreceiver = new TextControl(this, "Current Coordinate", "") {
            @Override
            public void valueChanged(String control_val) {
                /*** Write your DynamicControl code below this line ***/

                sendAltAz(control_val);
        ...
        /***** Simply type globalTriggerControlSender to generate this code ***/
        TriggerControl requestControld = new TriggerControlSender(this, "Get Coordinates").setControlScope(ControlScope.GLOBAL);
         ...
         ************************************************************/
        Clock requestClock = hb.createClock(200).addClockTickListener((offset, this_clock) -> {
            /*** Write your Clock tick event code below this line ***/
            requestControld.send();
